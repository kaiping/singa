...
INCLUDE_DIRS := ./include/ /usr/include $(HOME_DIR)/atlas/include /usr/include/openmpi
...
LIBRARY_DIRS := $(HOME_DIR)/lib64 $(HOME_DIR)/lib $(HOME_DIR)/atlas/lib $(HOME_DIR)/local/lib
