...
template <class A, class B>
struct hash<lapis::tuple2<A, B> > : public unary_function<lapis::tuple2<A, B> , size_t> {
  hash<A> ha;
  hash<B> hb;
...
template <class A, class B, class C>
struct hash<lapis::tuple3<A, B, C> > : public unary_function<lapis::tuple3<A, B, C> , size_t> {
  hash<A> ha;
  hash<B> hb;
  hash<C> hc;
