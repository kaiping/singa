...
inline ::google::protobuf::int32 GetRequest::shard() const {
  return shard_;
}
inline void GetRequest::set_shard(::google::protobuf::int32 value) {
  set_has_shard();
  shard_ = value;
}
...
inline ::google::protobuf::int32 PutRequest::shard() const {
  return shard_;
}
inline void PutRequest::set_shard(::google::protobuf::int32 value) {
  set_has_shard();
  shard_ = value;
}
...
inline ::google::protobuf::int32 UpdateRequest::shard() const {
  return shard_;
}
inline void UpdateRequest::set_shard(::google::protobuf::int32 value) {
  set_has_shard();
  shard_ = value;
}
